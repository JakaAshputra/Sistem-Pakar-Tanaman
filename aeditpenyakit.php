      ...
      <div class="container-fluid">
         ...
         <div class="collapse navbar-collapse" id="myNavbar">
            <ul class="nav navbar-nav">
               <li><a href="hamadanpenyakit.php"><button type="button" class="btn nav-btn btn-block active">HAMA dan PENYAKIT</button></a></li>
               <li><a href="gejala.php"><button type="button" class="btn nav-btn btn-block">GEJALA</button></a></li>
      ...
      <div class="row content">
         <div class="col-sm-8 text-left"></br>
            <form method="post">
               ...
               <div class="btn-submit"><button type="submit" name="submit" class="btn btn-primary">Simpan</button></div>
               <?php
