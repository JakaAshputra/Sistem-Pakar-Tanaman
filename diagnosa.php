...
<body>
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="myNavbar">
        <ul class="nav navbar-nav">
          <li><a href="index.php"><button type="button" class="btn nav-btn btn-block">BERANDA</button></a></li>
          <li><a href="diagnosa.php"><button type="button" class="btn nav-btn btn-block active">DIAGNOSA PENYAKIT</button></a></li>
  ...
  <div class="container-fluid text-center row content">
